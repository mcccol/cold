...
%token ECHO_FUNC ECHO_FILE DISCONNECT FILESTAT READ WRITE LS CONNECTIONS
...
%token CHILDREN ANCESTORS HAS_ANCESTOR SIZE IDENTS PACK UNPACK DIGESTABLE DEPENDS
