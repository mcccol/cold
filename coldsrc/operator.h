...
/* RSA Crypto operations (adminop.c). */
#ifdef RSACRYPT
void op_mkRSA(void);
void op_enRSA(void);
void op_enIDEA(void);
...
void op_MD5(void);
#else
/* keep space for the crypt operators even if they're absent */
#define op_mkRSA abort
#define op_enRSA abort
#define op_enIDEA abort
#define op_deIDEA abort
#define op_MD5 abort;
#endif
